...
<!-- badges: start -->
[![R-CMD-check](https://github.com/jiang-junyao/CACIMAR/workflows/R-CMD-check/badge.svg)](https://github.com/jiang-junyao/CACIMAR/actions)
<!-- badges: end -->
...
![](Readme figure/Workflow.png){ width=75% height=75% }
